...
Pod::Spec.new do |s|
    ...
    s.source           = { :git => "https://github.com/nativejong/mContact.git", :tag => s.version }
    s.social_media_url = 'https://twitter.com/artsy'

    s.platform     = :ios, '7.0'
    s.requires_arc = true
    
    s.public_header_files = "mContact.framework/Headers/*.h"
    s.source_files = "mContact.framework/Headers/*.h"
    s.vendored_frameworks = "mContact.framework"

    s.frameworks = 'UIKit', 'CoreText'
    s.module_name = 'mContact'
end
